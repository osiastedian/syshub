const about = {
  about: {
    ...
    features: {
      ...
      list: {
        f1: 'Facilitation of future Syscoin features and services',
        f2: 'Seniority benefits to masternode operators',
        f3: 'Z-DAG Protocol\'s instant asset transfer',
        f4: 'Scalability',
      },
    },
    masternodes: {
    ...
    governance: {
      ...
      description:{
        d1: 'Each month a pot of governance funding is generated by the Syscoin blockchain \'superblock\'. Any individual or group can submit a proposal to receive some of these funds.',
        d2: 'Sentry Node owners vote on the proposals using voting technology embedded in the Syscoin blockchain (accessible via the Qt wallet or syshub.org).',
        d3: 'At the end of the monthly voting period funds are distributed to the proposals with the greatest number of positive votes. Successful projects tend to be those that support and advance Syscoin Platform, such as marketing initiatives and application development.',
        d4: 'Syscoin have implemented a % decline schedule — starting the first month with 1,500,000 SYS and ending on the 24th month with 196,708 SYS. After that period, the superblock starts with 151,767 SYS a month and will decline 5% every year.',
      },
    },
    rewards: {
      title: 'Rewards',
      description: {
        d1: '75% of each regular block reward is distributed to Sentry Node operators as an incentive to continue running the node. Each payout amounts to roughly 25 SYS, though this will increase over time due to the Seniority Benefits mechanism.',
        d2: 'The likelihood of a Sentry Node receiving a payout is inversely proportional to the total number of SentryNodes on the network. At the time of writing, a Sentry Node is likely to receive a 53 SYS reward roughly once every 4-5 days.',
        d3: 'As a seniority benefit, Sentry Node operators receive a 35% bonus to their base reward after one year, and a 100% bonus after 2.5 years. This benefit is paid only if the collateral for an active Sentry Node is kept locked at the same address for the entire qualification period.',
      },
    },
    seniority: {
      ...
      txData: {
        gamma: {
          label: 'TX DATA GAMMA',
          blocks: '43,800 Blocks',
        },
        beta: {
          label: 'TX DATA BETA',
          blocks: '526,600 Blocks',
        },
        alpha: {
          label: 'TX DATA ALPHA',
          blocks: '1,314,000 Blocks',
        },
      },
      oneYear: {
        title: '1 YEAR 35% increase of base rate',
      },
      twoAndHalf: {
        title: '2.5 YEARS 100% increase of base rate',
      },
      blockInfo: {
        label: 'Syscoin Average Block is 60 Seconds. Therefore:',
      },
      note: {
        main: 'Please note that Seniority is based purely on the Transaction Block Height. The ONLY thing that will affect your Seniority is if you MOVE YOUR 100,000 Syscoin, which creates a new transaction, giving you a new Block Height. Stopping your Syscoin Sentry Node, restarting your server, closing QT, upgrading SentryNodes, Initialising your Sentry Node, changing your IP address, and anything you can possibly think of does not effect your Seniority.',
      },
      seniority: {
        s1: {
      ...
      note_legacy: { // check /About for more context on how to translate these..
        n1: {
