...
/**
 * Community Join Section Component
...
function CommunityJoin() {
  ...
  return (
    <section className="community-join">
      <h2 className="community-join__heading">
        Join our Community!
      </h2>

      <div className="community-join__content d-flex align-items-center gap-4">
        <div className="community-join__icon">
          <div className="community-join__icon-glow"></div>
          <svg className="community-join__icon-image" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="community-join__text-button d-flex flex-column gap-3">
          <p className="community-join__text">
